...
# Un algoritmo di ottimizzazione, ovvero una procedura iterativa che mira a minimizzare una determinata funzione, giunge a convergenza quando due valori successivi della procedura sono sostanzialmente indistinguibili tra loro. Ad esempio, quando la funzione assume valori reali, questo può voler dire che la differenza in valore assoluto tra due valori consecutivi dell'algoritmo è prossima a zero.
