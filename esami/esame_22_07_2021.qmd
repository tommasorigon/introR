...
2. (5pt) Si sfrutti questo risultato per ottenere una stima alternativa (ma equivalente) del valore atteso $E(Y^2)$.
...
3. (6pt) Si conduca uno studio di simulazione e si verifichi empiricamente che lo stimatore $T_1$ è consistente al crescere di $n$. 
...
1. (1pt) Si ottenga la matrice di correlazione. 
